...
// prompt as a workspace-local context file before launch. The initial task
// prompt is delivered as a positional argument after `--`. The --yolo flag
// corresponds to bypass-permissions mode.
//
